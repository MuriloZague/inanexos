...
export const Card: React.FC<{ form: Formulario }> = ({ form }) => {
  return (
    <div className="bg-white rounded-lg border-2 border-gray-300 hover:border-blue-200 hover:shadow-lg transition">
      ...
      <p className="text-[#5c708a] text-[1rem] mt-4">{form.descricao}</p>
      </div>
      ...
      <div className="border-t border-gray-300 px-6 py-4 flex items-center justify-between">
        ...
        <div>
          <a href={form.link} className="bg-[#004db3] hover:bg-[#0a63d8] hover:cursor-pointer transition text-white flex py-[0.4rem] px-3 rounded-md items-center">
